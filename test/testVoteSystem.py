...
async def run():
    ...
    developPrototypeFirst = PollOption("Develop a prototype first", short="ProtoFirst")
    startDirectlyWithMainSoftware = PollOption("Start directly with the main software", short="StartWithMain")
    howToContinueSoftwareDevelopment = DeadlinePoll(question="What is the best way to continue with the voting bot software?", options=[developPrototypeFirst, startDirectlyWithMainSoftware], short="SoftwareDevelopment", timespan=12)
    ...
    pool.addAddPollCallback(addPoll)
